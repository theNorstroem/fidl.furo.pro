...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.82ac4ca624221256fa2e4d4ed5a423ed5f26f870ecc3eaa3ea066efbe6586e07.js',function(){input.required=false;search();});}
