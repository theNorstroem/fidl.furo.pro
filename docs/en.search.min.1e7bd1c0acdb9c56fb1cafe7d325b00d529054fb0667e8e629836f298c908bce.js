...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ce9714cd349465cd24e5b91391ab0d9a6d245efe909b60ab41a2ab8d236caf24.js',function(){input.required=false;search();});}
