...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/fidl.furo.pro/flexsearch.min.js');loadScript('/fidl.furo.pro/en.search-data.min.0a4977395e0120905104bbba98b05a35173860b39ea153be4e4b548a02c2ad5d.js',function(){input.required=false;search();});}
