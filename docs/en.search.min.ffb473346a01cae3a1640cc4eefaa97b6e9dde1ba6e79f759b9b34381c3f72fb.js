...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.fcb1d793821dfb7555d8ddf73816f3e00c0bddccbe767a53e4293bae0a1fd0a2.js',function(){input.required=false;search();});}
